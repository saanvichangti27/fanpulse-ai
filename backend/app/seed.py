...
def seed_db():
    ...
    matches = [
        ...
        Match(id="m_004", home_team="USA", away_team="Mexico", kickoff_time="2026-07-07T18:00:00Z", stage=4, venue_capacity=90000, city="Los Angeles", city_population_m=3.9, home_rank=11, away_rank=15, rivalry_flag=1, status="upcoming"),
